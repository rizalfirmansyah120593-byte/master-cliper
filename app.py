...
class MasterCliper(ctk.CTk):
    ...
    def show_cookies_required_dialog(self):
        ...
        english_btn = ctk.CTkButton(buttons_frame,
            ...
            command=lambda: [
                webbrowser.open("https://github.com/rizalfirmansyah120593-byte/Master Cliper/blob/master/GUIDE.md#3-setup-youtube-cookies"),
                dialog.destroy()
            ])
        ...
        indonesian_btn = ctk.CTkButton(buttons_frame,
            ...
            hover_color=("#2E7AB8", "#16527D"),
            command=lambda: [
                webbrowser.open("https://github.com/rizalfirmansyah120593-byte/Master Cliper/blob/master/PANDUAN.md#3-setup-cookies-youtube"),
                dialog.destroy()
            ])
    ...
    def check_update_silent(self):
        ...
        try:
            ...
            req = urllib.request.Request(url, headers={'User-Agent': 'Master Cliper'})
