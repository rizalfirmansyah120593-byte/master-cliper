...
# Create DMG (optional)
create-dmg \
    --volname "MasterCliper" \
    --volicon "assets/icon.icns" \
    --window-size 600 400 \
    --icon "MasterCliper.app" 150 185 \
    --app-drop-link 450 185 \
    "dist/MasterCliper.dmg" \
    "dist/MasterCliper.app"
```

**macOS notes:**
- User data is stored in `~/Library/Application Support/MasterCliper/` (persists across app updates)
