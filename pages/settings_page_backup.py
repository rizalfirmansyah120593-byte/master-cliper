"""
Settings page for Master Cliper
"""
...
Stay tuned for updates! 🎵"""
    ...
    def create_about_tab(self):
        ...
        ctk.CTkLabel(info_frame, text="Master Cliper", font=ctk.CTkFont(size=20, weight="bold")).pack()
...
and YouTube Shorts."""
        ...
        ctk.CTkButton(links_frame, text="⭐ GitHub Repository", height=40,
            ...
            command=lambda: self.open_url("https://github.com/rizalfirmansyah120593-byte/Master Cliper")).pack(fill="x", pady=2)
