...
class PageHeader(ctk.CTkFrame):
    ...
    def create_header(self):
        ...
        ctk.CTkLabel(title_col, text="Master Cliper", font=ctk.CTkFont(size=20, weight="bold")).pack(anchor="w")
...
class PageFooter(ctk.CTkFrame):
    ...
    def create_footer(self):
        ...
        try:
            ...
            copyright_text = f"© {current_year} Master Cliper • v{__version__}"
        except:
            copyright_text = "© 2026 Master Cliper"
